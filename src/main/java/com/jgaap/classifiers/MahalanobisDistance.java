...
//		ImmutableMap.Builder<String, Histogram> knownHistogramsBuilder = ImmutableMap.builder();
//		List<Histogram> histograms = new ArrayList<EventMap>(knowns.size());
//		for(Histogram known : knowns){
//			eventsBuilder.addAll(known.uniqueEvents());
//			histograms.add(known);
//			knownHistogramsBuilder.put(known, known);
//		}
