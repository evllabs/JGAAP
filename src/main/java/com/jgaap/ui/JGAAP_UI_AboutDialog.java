...
public class JGAAP_UI_AboutDialog extends JDialog {
	...
	public JGAAP_UI_AboutDialog() {
		...
		ImageIcon jgaapIcon = new ImageIcon(JGAAP_UI_AboutDialog.class.getResource("/ui/jgaap-icon.png"));
		...
		ImageIcon evlIcon = new ImageIcon(JGAAP_UI_AboutDialog.class.getResource("/ui/EVL_Icon_duq.png"));
		...
		InputStream fontIs = JGAAP_UI_AboutDialog.class.getResourceAsStream("/ui/LucidaGrande.ttf");
		Font lgFont = null;
		try {
