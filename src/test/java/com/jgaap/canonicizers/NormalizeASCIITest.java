...
public class NormalizeASCIITest {
	...
	/**
	 * Test method for
	 * {@link com.jgaap.canonicizers.NormalizeASCII#process(String)}
	 * .
	 */
	@Test
	public void testProcess() {
		char[] build = new char[256];
		for (int i=0;i<255;i++)
			build[i] = (char) i;

		String sample = new String(build);
		...
		String test = new NormalizeASCII().process(sample);
