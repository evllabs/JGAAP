...
/**
 * This event set is all "words" (NaiveWordEventDriver) with M <= length <= N
 * (M and N being parameters "M" and "N" respectively)
 *
 * @since 4.1
 **/
    ...
    public EventSet createEventSet(DocumentSet ds) {
        ...
        if (!(param = (getParameter("N"))).equals("")) {
            try {
                ...
                System.out.println("Warning: cannot parse N(upper bound):" + param
                        + " as int");
        ...
        if (!(param = (getParameter("M"))).equals("")) {
            try {
                ...
                System.out.println("Warning: cannot parse M(lower bound):" + param
                        + " as int");
