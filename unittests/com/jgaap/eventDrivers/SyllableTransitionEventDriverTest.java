...
public class SyllableTransitionEventDriverTest {
	...
	public void testCreateEventSetDocumentSet() throws EventGenerationException {
		...
		tmp.add(new Event("1-1", null));
		tmp.add(new Event("1-1", null));
		tmp.add(new Event("1-2", null));
		tmp.add(new Event("2-2", null));
		tmp.add(new Event("2-2", null));
		tmp.add(new Event("2-2", null));
		tmp.add(new Event("2-3", null));
		tmp.add(new Event("3-1", null));
		tmp.add(new Event("1-1", null));
		tmp.add(new Event("1-1", null));
		tmp.add(new Event("1-1", null));
		tmp.add(new Event("1-1", null));
		...
		tmp.add(new Event("1-1-1", null));
		tmp.add(new Event("1-1-1", null));
		tmp.add(new Event("1-1-2", null));
		tmp.add(new Event("1-2-2", null));
		tmp.add(new Event("2-2-2", null));
		tmp.add(new Event("2-2-2", null));
		tmp.add(new Event("2-2-3", null));
		tmp.add(new Event("2-3-1", null));
		tmp.add(new Event("3-1-1", null));
		tmp.add(new Event("1-1-1", null));
		tmp.add(new Event("1-1-1", null));
		tmp.add(new Event("1-1-1", null));
		tmp.add(new Event("1-1-1", null));
