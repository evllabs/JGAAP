...
public class RandomAnalysisTest {
	...
	/**
	 * Test method for {@link com.jgaap.classifiers.RandomAnalysis#analyze(com.jgaap.generics.EventSet, java.util.Vector)}.
	 */
	@Test
	public void testAnalyze() {
		...
		EventSet unknownPeter = new EventSet();
		...
		unknownMary.events.addAll(test3);
		...
		int goodTest = 0; // hold the number of times Confidence interval covers Prob of Mary = .62
		...
		double probGood;
		probGood = goodTest/100; // this prob should be greater than .95 because the confidence interval
